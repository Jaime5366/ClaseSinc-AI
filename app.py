    ...
    with col1:
        with st.container(border=True):
            ...
            media_file = st.file_uploader(
                "Sube la grabación o video de la clase (.mp3, .wav, .mp4, .mov, .m4a, .mkv)", 
                type=["mp3", "wav", "mp4", "mov", "avi", "mkv", "m4a"],
                help="Sube directamente tu grabación de audio o archivo de video. El sistema extraerá el audio de forma automática."
            )
